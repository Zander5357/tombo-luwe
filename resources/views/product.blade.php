			...
			<?php
                    ...
                    <div class="col-md-5">
						<div class="product-details">
							...
							<div>
								<h3 class="product-price">RP' . $row['product_price'] . '<del class="product-old-price">RP40000</del></h3>
								<span class="product-available">In Stock</span>
							</div>
							<p>Unlimited Stock gan</p>
						...
						<div id="product-tab">
							...
							<div class="tab-content">
								...
								<div id="tab1" class="tab-pane fade in active">
									<div class="row">
										<div class="col-md-12">
											<p>Barang NEW BUKAN SECOND, dengan harga termurah sepanjang masa.</p>
										</div>
									</div>
								</div>
								<!-- /tab1  -->
								...
								<div id="tab2" class="tab-pane fade in">
									<div class="row">
										<div class="col-md-12">
											<p>Selalu siap sedia untuk kenyamanan Anda</p>
										</div>
									</div>
								</div>
								<!-- /tab2  -->
												...
												<ul class="reviews">
													<li>
														<div class="review-heading">
															<h5 class="name">Ishaq</h5>
															<p class="date">16 JAN 2023, 7:39 PM</p>
													...
													<li>
														<div class="review-heading">
															<h5 class="name">Sugitno</h5>
															<p class="date">27 DEC 2022, 2:21 PM</p>
															<div class="review-rating">
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
													...
													<li>
														<div class="review-heading">
															<h5 class="name">Saleho</h5>
															<p class="date">14 JAN 2022, 9:47 PM</p>
															<div class="review-rating">
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
														...
														<div class="review-body">
															<p>Ada dent, tapi gamasalah sih</p>
														</div>
													</li>
												</ul>
					...
					echo "
								...
								<a href='product.php?p=$pro_id'><div class='product'>
									...
									<div class='product-body'>
										...
										<h4 class='product-price header-cart-item-info'>$pro_price<del class='product-old-price'>RP20000</del></h4>
										<div class='product-rating'>
											<i class='fa fa-star'></i>
											<i class='fa fa-star'></i>
											<i class='fa fa-star'></i>
